...
def RunSeed(seed, data_index, dataset_name, w1, w2, w3):
    command = "./NuWSC/NuWSC " + "benchmark/" + dataset_name + '/' + str(data_index) + " 1000 " + str(seed) + " " + str(w1) + " " + str(w2) + " " + str(w3) + " > results/" + dataset_name + '/' + str(data_index) + "_with_seed_" + str(seed) + '.out'
    os.system(command)
